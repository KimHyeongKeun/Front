...
export const IconLetterLogo = styled.h2<{themeState:any}>`
  color: ${(props: IStyledProps) => props.themeState.borderColor};
  font-size: ${theme.font.fontsizes.h2};
`;

// SVG temp solution
export const GitSVG = styled(Git)<{themeState:any}>`
  color: ${(props: IStyledProps) => props.themeState.borderColor};
  width: 110%;
  height: 110%;
`;
export const TwitterSVG = styled(Twitter)<{themeState:any}>`
  color: ${(props: IStyledProps) => props.themeState.borderColor};
  width: 110%;
  height: 110%;
`;
export const BlogSVG = styled(Blog)<{themeState:any}>`
  color: ${(props: IStyledProps) => props.themeState.borderColor};
  width: 110%;
  height: 110%;
`;
export const AboutSVG = styled(About)<{themeState:any}>`
  color: ${(props: IStyledProps) => props.themeState.borderColor};
  width: 110%;
  height: 110%;
`;
export const ProjectsSVG = styled(Projects)<{themeState:any}>`
  color: ${(props: IStyledProps) => props.themeState.borderColor};
  width: 110%;
  height: 110%;
`;
export const ContactSVG = styled(Contact)<{themeState:any}>`
  color: ${(props: IStyledProps) => props.themeState.borderColor};
  width: 110%;
  height: 110%;
`;
export const LinkedInSVG = styled(Linkedin)<{themeState:any}>`
  fill: ${(props: IStyledProps) => props.themeState.borderColor};
  width: 110%;
  height: 110%;
`;
export const ThreeDeeSVG = styled(ThreeDee)<{themeState:any}>`
  fill: ${(props: IStyledProps) => props.themeState.borderColor};
  width: 110%;
  height: 110%;
`;